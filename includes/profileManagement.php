										...
										<div class="tab-content">
												...
												<div id="tab2" class="tab active">
													...
													$sql = "SELECT * FROM `user` WHERE `userID` = ".$_SESSION['user']; //I want to see all existing announcements from database
														...
														echo '	<input id="title" name="title" type="text" placeholder="' .$row['title'].'">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<label id="form-text" class="textlabelwhite">*First Name:</label>';
														echo '	<input id="firstName" name="firstName" type="text" placeholder="' .$row['firstName'].'">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<label id="form-text" class="textlabelwhite">*Last Name:</label>';
														echo '	<input id="lastName" name="lastName" type="text" placeholder="' .$row['lastName'].'">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<label id="form-text" class="textlabelwhite">Suffix:</label>';
														echo '	<input id="suffix" name="suffix" type="text" placeholder="' .$row['suffix'].'">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<label id="form-text" class="textlabelwhite">Suffix Two:</label>';
														echo '	<input id="suffixTwo" name="suffixTwo" type="text" placeholder="' .$row['suffixTwo'].'">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<label id="form-text" class="textlabelwhite">*Email:</label>';
														echo '	<input id="email" name="email" type="text" placeholder="' .$row['email'].'">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '    <label id="form-text" class="textlabelwhite">*Employer:</label>';
														echo '	<input id="employer" name="employer" type="text" placeholder="' .$row['employer'].'">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '    <label id="form-text" class="textlabelwhite">Expertise:</label>';
														echo '	<input id="expertise" name="expertise" type="text" placeholder="' .$row['expertise'].'">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '    <label id="form-text" class="textlabelwhite">*Primary Address:</label>';
														echo '	<input id="primaryAddress" name="primaryAddress" placeholder="123 Main" type="text">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<label id="form-text" class="textlabelwhite">Secondary Address:</label>';
														echo '	<input id="secondaryAddress" name="secondaryAddress" placeholder="123 Main" type="text">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<label id="form-text" class="textlabelwhite">*City:</label>';
														echo '	<input id="city" name="city" type="text" placeholder="Big Rapids">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<label id="form-text" class="textlabelwhite">*State/Province:</label>';
														echo '	<input id="state" name="state" type="text" placeholder="Michigan">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<label id="form-text" class="textlabelwhite">*Zip Code:</label>';
														echo '	<input id="zip" name="zip" placeholder="49307" type="text">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<label id="form-text" class="textlabelwhite">*Country:</label>';
														echo '	<input id="country" name="country" placeholder="United States" type="text">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<li class="textfield-container">';
														...
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '	<label id="form-text" class="textlabelwhite">*Country Code:</label>';
														echo '	<input id="countryCode" name="countryCode" placeholder="1" type="text">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '    <label id="form-text" class="textlabelwhite">*Primary Phone:</label>';
														echo '	<input id="primaryPhone" name="primaryPhone" placeholder="5555555555" type="text">';
														echo '</li>';
														echo '<li class="textfield-container">';
														echo '    <label id="form-text" class="textlabelwhite">Secondary Phone:</label>';
														echo '	<input id="secondaryPhone" name="secondaryPhone" placeholder="5555555555" type="text">';
														echo '</li>';
														}
														?>
