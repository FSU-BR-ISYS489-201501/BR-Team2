...
Description:
	This page lists all published cases, allows the editor to submit a new case, and allows the editor to toggle the 
	visibility status of all current cases. This page is mainly forms with a single function, See upload.php and caseUpdatePull.php 
	for the other functions of this page.
*/
session_start();
include('upload.php');
include('includes/caseEditPull.php');
            ...
            <div class="row gutter">
                ...
                <div class="col m4 s6">
                    ...
                    <div class="titleboxmargin grey" style="width:100%;">
                        ...
                        <h3 class="title">Current Cases:</h3>
                    </div>
                    ...
                    <div class="yellow-light" style="height:370px; width:100%; position:relative; overflow:auto;">
                       <table style="position:absolute; top:0; overflow-y:scroll;">
									...
									<?php
										...
										$caseMgmtReturn = "SELECT * FROM `finalCase`";
										...
										foreach ($caseMgmt as $row) {
											...
											print "<tr> <td>" . $row["fcaseID"] . "</td> <td>" . $row["title"] . "</td> <td>" . $row["datePublished"] . "</td> <td>" . $displayed . "</td></tr><br/>";
										}
										?>  
										</tbody>  
									</table>
                ...
                <div class="col m8 s6">
                    ...
                    <div class="titlebox grey">
                        ...
                        <h3 class="title">Upload New JCI Case</h3>
                    </div>
                    <!-- Upload form -->
                        ...
                        <form action="upload.php" method="post" enctype="multipart/form-data">
                            <ul class="list-form">
                                <li class="textfield-container">
                                    ...
                                    <input id="text" type="text" name="caseTitle" placeholder="Case Title">
                                </li>
                                <li class="textfield-container">
								...
								<li class="textfield-container">
                                        <label>Authors:</label>
                                        <textarea id="textarea" name="authors" rows="7" placeholder="Author(s) name (Separate with commas)"></textarea>
                                </li>
                                <li class="textfield-container">
                    ...
                    <form action="" method="post">
									<ul class="list-form">
										<li class="textfield-container">
								    		...
								    		<input id="text" name="fcaseID" placeholder="10" type="text">
										</li>
										<li class="textfield-container">
                                        	<li class="textfield-container">
											<label for="text" class="textlabelblack">Status:</label>
												<div class="statedropdown">
													<label for="select" class="select">
														<select name="fcaseStatus" id="select">
										...
										<span style="padding-left:10px;"><input id="caseUpdate" style="border:0;" name="caseUpdate" class="button" type="submit" value=" Update "></span>
