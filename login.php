...
Description:
	This page grabs is the memeber registration/login with a default active tab being login.
			...
			<div class="row gutter">
				<div class="col s4 m4">
					...
					<div class=" col s8 m8 tabs"><!--Tabs to switch between either New User or Current User-->
						<ul class="tab-links">
						        <li><a href="#tab2"><img class="tabicon" src="../images/newusericon.svg">New Users</a></li>
						        <li class="active"><a href="#tab1"><img class="tabicon" src="../images/currentusericon.svg">Current Users</a></li>
						</ul>
						<div class="tab-content">
						        <div id="tab1" class="tab active">
									...
									<ul class="list-form">
										...
										<li>
                                        		<input id="login-button" name="submit" class="button" style="border:0;" type="submit" value=" Login "><!--Action: Attempts to Login-->
												<a href="recoverAccount.php" class="button" style="float:right; width:135px;">Recover Account</a><!--Action: Attempts to Recover Account-->
	                                    </li>
